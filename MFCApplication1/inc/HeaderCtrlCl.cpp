...
void CHeaderCtrlCl::OnPaint()
{
	...
	{ 
		...
		dc.SetBkMode(TRANSPARENT);   //设置始终以背景色作为字体的背景色
		CFont nFont ,* nOldFont; 
		//dc.SetTextColor(RGB(250,50,50)); 
		dc.SetTextColor(m_color);
		nFont.CreateFont(m_fontHeight,m_fontWith,0,0,0,FALSE,FALSE,55,0,0,0,0,0,_TEXT("宋体"));//创建字体 (高、宽、水平倾斜度、垂直倾斜度、下滑线、加粗、中滑线·····)
		...
		tRect.OffsetRect(0,ofst/2);//矩形y向下移动ofst/2
		dc.DrawText(m_HChar[i],&tRect,nFormat); //CString CRect 对齐方式 
	...
	GetClientRect(clientRect);//clientRect接受客户区坐标
