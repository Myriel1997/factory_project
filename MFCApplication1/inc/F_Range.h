...
class CF_Range : public COleDispatchDriver
{
public:
	CF_Range(){} // 调用 COleDispatchDriver 默认构造函数
	CF_Range(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CF_Range(const CF_Range& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void put_Borders(long Edge, long newValue)
	{
		...
		InvokeHelper(0x68030007, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, Edge, newValue);
	}
